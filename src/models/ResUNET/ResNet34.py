...
class ResUNetResNet34(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, freeze=True):
        super(ResUNetResNet34, self).__init__()
    ...
    def forward(self, x):
        ...
        d1 = self.up1(x4, x3)   # 512 + 256 -> 256
        d2 = self.up2(d1, x2)   # 256 + 128 -> 128
        d3 = self.up3(d2, x1)   # 128 + 64 -> 64
