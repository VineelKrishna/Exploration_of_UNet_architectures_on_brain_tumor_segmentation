...
class VGG16Encoder(nn.Module):
    def __init__(self, freeze=True):
        ...
        self.enc3 = features[10:17]  # conv3_1 to relu3_3 (256)
        self.enc4 = features[17:24]  # conv4_1 to relu4_3 (512)
        self.enc5 = features[24:31]  # conv5_1 to relu5_3 (512)
...
class ResUNetVGG16(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, freeze=True):
        super(ResUNetVGG16, self).__init__()
